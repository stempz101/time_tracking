...
<head>
    ...
    <title><fmt:message key="add_activity" bundle="${myBundle}" /></title>
</head>
<body>
            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/add-act" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/add-act" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
...
<section class="container">
    <div class="row">
        <div class="col-12 text-center"><h3><fmt:message key="add_activity" bundle="${myBundle}" /></h3></div>
        <div class="col-2"></div>
        <form action="<%= request.getContextPath() + "/u/add-act" %>" class="col-8 border rounded mt-2"
              method="post"
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" class="form-control" id="activityName" name="activityName" placeholder="<fmt:message key="name" bundle="${myBundle}" />"
                       value="<c:out value="${sessionScope.activity.name}" />">
            </div>
            <div class="form-group mx-4">
                ...
                <div class="row row-cols-6 g-0">
                    <c:forEach var="category" items="${requestScope.categoryList}">     <%-- localize --%>
            ...
            <div class="form-group mx-4">
                ...
                <textarea class="form-control" id="activityDescription" name="activityDescription" rows="8"
                          placeholder="<fmt:message key="description" bundle="${myBundle}" />...">${sessionScope.activity.description}</textarea>
            </div>
            <div class="form-group mx-4">
            ...
            <div class="row form-group mx-4 my-3">
                <button class="btn btn-lg btn-primary" type="submit" name="sendMe" value="1"><fmt:message key="send_request" bundle="${myBundle}" /></button>
            </div>
        </form>
        <div class="col-2"></div>
    </div>
