            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/activities" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/activities" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
...
<div class="container">
    ...
    <div class="row">
        <form action="<%= request.getContextPath() + "/u/activities" %>"
              class="d-flex col-12 col-lg-auto me-lg-auto mb-2 justify-content-center align-items-center w-50"
              method="get">
            <input type="search" name="search" class="form-control" placeholder="<fmt:message key="search" bundle="${myBundle}" />..." aria-label="Search"
    ...
    <form action="<%= request.getContextPath() + "/u/activities" %>" method="get">
        <div class="row">
        ...
        <div class="row">
            <div class="d-inline-flex justify-content-between">
                <div class="d-flex">
                    <input type="number" class="form-control me-1" style="width: 100px;" name="from" placeholder="<fmt:message key="from" bundle="${myBundle}" />"
                           aria-label="From" min="0" max="${requestScope.peopleMaxCount}" value="${param.from}">
                    <input type="number" class="form-control ms-1" style="width: 100px;" name="to" placeholder="<fmt:message key="to" bundle="${myBundle}" />"
                           aria-label="To" min="0" max="${requestScope.peopleMaxCount}" value="${param.to}">
                ...
                <div class="card shadow-sm">
                    ...
                    <c:choose>
                        <c:when test="${activity.image == null}">
                            <a href="<%=request.getContextPath() + "/u/activity"%>?id=${activity.id}"
                        ...
                        <c:otherwise>
                            <a href="<%=request.getContextPath() + "/u/activity"%>?id=${activity.id}"
                               class="text-black text-decoration-none">
                                <div class="bd-placeholder-img card-img-top w-100"
                                     style="background-image: url(${pageContext.request.contextPath}<%=FilePaths.GET_ACTIVITY_IMG_UPLOAD_DIRECTORY%>${activity.image});
                                             height: 225px;background-size: cover;"></div>
                            </a>
                        </c:otherwise>
                    </c:choose>
                    <div class="card-body">
