            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/requests" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/requests" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="row mb-2">
        ...
        <div class="row mt-2">
            <div class="d-inline-flex justify-content-between align-items-center">
                ...
                <div class="d-flex">
                    <form action="<%= request.getContextPath() + "/u/requests" %>"
                          class="d-flex col-12 col-lg-auto mx-0 mb-2 justify-content-center align-items-center"
                          method="get">
                        <div class="d-flex">
                            <a href="<%= request.getContextPath() + "/u/requests" %>" class="btn btn-primary"><fmt:message key="reset" bundle="${myBundle}" /></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <c:choose>
                                                <c:when test="${request.forDelete}">
                                                    <a href="<%= request.getContextPath() + "/u/canc-req-rem" %>?id=${request.id}"
                                                       class="btn btn-danger"><fmt:message key="cancel" bundle="${myBundle}" /></a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="<%= request.getContextPath() + "/u/canc-req-add" %>?id=${request.id}"
                                                       class="btn btn-danger"><fmt:message key="cancel" bundle="${myBundle}" /></a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
