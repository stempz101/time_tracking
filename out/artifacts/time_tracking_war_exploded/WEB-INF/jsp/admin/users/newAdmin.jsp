...
<head>
    ...
    <title><fmt:message key="new_admin" bundle="${myBundle}" /></title>
</head>
<body>
            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/new-adm" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/new-adm" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
...
<section class="container">
    <div class="row">
        <div class="col-12 text-center"><h3><fmt:message key="new_admin" bundle="${myBundle}" /></h3></div>
        <div class="col-md-3 col-lg-4"></div>
        <form action="<%= request.getContextPath() + "/a/new-adm"%>" class="col-lg-4 border rounded" method="post"
              enctype="multipart/form-data">
            <c:choose>
                <c:when test="${sessionScope.messageError != null}">
                ...
                <c:when test="${sessionScope.successMessage != null}">
                    <div class="form-group mx-4 mt-4">
                        <div class="alert alert-success my-1 py-1"><c:out value="${sessionScope.successMessage}" /></div>
                    </div>
                </c:when>
            </c:choose>
