            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/add-act" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/add-act" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
        ...
        <form action="<%= request.getContextPath() + "/a/add-act" %>" class="col-8 border rounded mt-2"
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" class="form-control" id="activityName" name="activityName"
                       value="<c:out value="${sessionScope.activity.name}" />" placeholder="<fmt:message key="name" bundle="${myBundle}" />">
            </div>
            <div class="form-group mx-4">
