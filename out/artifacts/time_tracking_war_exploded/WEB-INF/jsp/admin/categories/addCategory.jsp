...
<head>
    ...
    <title><fmt:message key="add_category" bundle="${myBundle}" /></title>
</head>
<body>
            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/add-cat" %>?lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/add-cat" %>?lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
...
<section class="container">
    <div class="row">
        <div class="col-12 text-center"><h3><fmt:message key="add_category" bundle="${myBundle}" /></h3></div>
        <div class="col-2"></div>
        <form action="<%= request.getContextPath() + "/a/add-cat" %>" class="col-8 border rounded mt-2"
              method="post">
            ...
            <div class="form-group mx-4">
                <label for="categoryEN" class="col-form-label-lg"><fmt:message key="category" bundle="${myBundle}" /> (EN) <p class="d-inline-block mb-0"
                                                                                   style="color: red">*</p></label>
                <input type="text" class="form-control" id="categoryEN" name="categoryEN"
                       value="${sessionScope.categoryEN}" placeholder="Category">
            </div>
            <div class="form-group mx-4">
                <label for="categoryUA" class="col-form-label-lg"><fmt:message key="category" bundle="${myBundle}" /> (UA) <p class="d-inline-block mb-0"
                                                                                   style="color: red">*</p></label>
                <input type="text" class="form-control" id="categoryUA" name="categoryUA"
                       value="${sessionScope.categoryUA}" placeholder="Категорія">
            </div>
            <div class="row form-group mx-4 my-3">
                <button class="btn btn-lg btn-primary" type="submit" name="sendMe" value="1"><fmt:message key="create" bundle="${myBundle}" /></button>
            </div>
        </form>
        <div class="col-2"></div>
    </div>
