...
<head>
    ...
    <title><fmt:message key="title.edit_photo" bundle="${myBundle}" /></title>
</head>
<body>
                    ...
                    <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-photo" %>?lang=en_EN">EN</a></li>
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-photo" %>?&lang=uk_UA">UA</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/edit-photo" %>?lang=en_EN">EN</a></li>
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/edit-photo" %>?lang=uk_UA">UA</a></li>
                            </ul>
                        </li>
                    </ul>
...
<section class="container">
    <div class="row">
        ...
        %>
        <form action="<%= request.getContextPath() + role + "/edit-photo"%>" class="col-lg-4 border rounded" method="post"
            ...
            <div class="form-group mx-4">
                ...
                <input type="file" name="image" id="image" class="form-control" accept=".jpg,.png,.svg">
            </div>
