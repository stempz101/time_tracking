...
/**
 * Servlet, that responsible for showing requests (admin)
 */
@WebServlet("/a/requests")
public class RequestsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            logger.info("Opening Requests page (admin)");
            req.getServletContext().getRequestDispatcher("/WEB-INF/jsp/admin/requests/requests.jsp").forward(req, resp);
