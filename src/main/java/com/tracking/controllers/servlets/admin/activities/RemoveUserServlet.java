...
/**
 * Servlet, that responsible for removing user from activity (admin)
 */
@WebServlet("/a/activity-remove-user")
public class RemoveUserServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(RemoveUserServlet.class);
