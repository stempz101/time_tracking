...
/**
 * Servlet, that responsible for deleting request (admin)
 */
@WebServlet("/a/del-req")
public class RemoveRequestServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(RemoveRequestServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            req.setAttribute("successMessage", bundle.getString("message.req_deleted"));
