...
/**
 * Servlet, that responsible for showing request (user)
 */
@WebServlet("/u/request")
public class RequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            logger.info("Opening Request (id=" + requestId + ") page (user)");
            req.getServletContext().getRequestDispatcher("/WEB-INF/jsp/user/requests/request.jsp").forward(req, resp);
