...
/**
 * Servlet, that responsible for starting activity (user)
 */
@WebServlet("/u/activity-start")
public class StartTimeServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(StartTimeServlet.class);
