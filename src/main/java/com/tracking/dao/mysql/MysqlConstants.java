...
public abstract class MysqlConstants {
    ...
    public static final String SELECT_ACTIVITIES = "SELECT * FROM activities WHERE people_count >= ? AND people_count <= ? " +
            "ORDER BY people_count DESC, create_time DESC, name LIMIT ?, ?";
    public static final String SELECT_ACTIVITIES_ORDER = "SELECT * FROM activities WHERE people_count >= ? AND people_count <= ? " +
    ...
    public static final String SELECT_USERS = "SELECT id, last_name, first_name, image, " +
            ...
            "LIMIT ?, ?";
    public static final String SELECT_USERS_ORDER = "SELECT id, last_name, first_name, image, " +
            "activity_count, spent_time, is_admin, is_blocked FROM users " +
            "ORDER BY " + ORDER_BY + " " +
            "LIMIT ?, ?";
    public static final String SELECT_USERS_WHERE_NAME = "SELECT id, last_name, first_name, image, " +
            "activity_count, spent_time, is_admin, is_blocked FROM users " +
            "WHERE last_name LIKE ? AND first_name LIKE ? " +
            "ORDER BY is_admin DESC, last_name " +
            "LIMIT ?, ?";
    public static final String SELECT_USERS_WHERE_NAME_ORDER = "SELECT id, last_name, first_name, image, " +
            "activity_count, spent_time, is_admin, is_blocked FROM users " +
            "WHERE last_name LIKE ? AND first_name LIKE ? " +
            "ORDER BY " + ORDER_BY + " " +
            "LIMIT ?, ?";
