...
<head>
    ...
    <title><fmt:message key="edit_category" bundle="${myBundle}" /></title>
</head>
<body>
            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-cat" %>?id=${param.id}&lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-cat" %>?id=${param.id}&lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
...
<section class="container">
    <div class="row">
        <div class="col-12 text-center"><h3><fmt:message key="edit_category" bundle="${myBundle}" /></h3></div>
        <div class="col-2"></div>
