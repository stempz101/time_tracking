            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/request" %>?id=${param.id}&lang=en_EN">EN</a></li>
                        <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/request" %>?id=${param.id}&lang=uk_UA">UA</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="row">
        ...
        <div class="col-8 border rounded mt-2">
            ...
            <div class="row form-group mx-4 my-3">
                <c:choose>
                    <c:when test="${requestScope.request.status.value.equals('CONFIRMED')}">
                        <a href="<%= request.getContextPath() + "/u/requests" %>"
                    ...
                    <c:when test="${requestScope.request.status.value.equals('WAITING')}">
                        <c:choose>
                            <c:when test="${requestScope.request.forDelete}">
                                <a href="<%= request.getContextPath() + "/u/canc-req-rem" %>?id=${requestScope.request.id}"
                                   class="btn btn-lg btn-danger mt-1"><fmt:message key="cancel" bundle="${myBundle}" /></a>
                            </c:when>
                            <c:otherwise>
                                <a href="<%= request.getContextPath() + "/u/canc-req-add" %>?id=${requestScope.request.id}"
                                   class="btn btn-lg btn-danger mt-1"><fmt:message key="cancel" bundle="${myBundle}" /></a>
                            </c:otherwise>
                        </c:choose>
                        <a href="<%= request.getContextPath() + "/u/requests" %>"
