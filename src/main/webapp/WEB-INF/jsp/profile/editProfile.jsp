...
<head>
    ...
    <title><fmt:message key="title.edit_profile" bundle="${myBundle}" /></title>
</head>
<body>
                    ...
                    <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang">
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-prof" %>?lang=en_EN">EN</a></li>
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/a/edit-prof" %>?lang=uk_UA">UA</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu text-small" aria-labelledby="dropdownLang2">
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/edit-prof" %>?lang=en_EN">EN</a></li>
                                <li><a class="dropdown-item" href="<%= request.getContextPath() + "/u/edit-prof" %>?lang=uk_UA">UA</a></li>
                            </ul>
                        </li>
                    </ul>
...
<section class="container">
    <div class="row">
        ...
        %>
        <form action="<%= request.getContextPath() + role + "/edit-prof"%>" class="col-lg-4 border rounded" method="post">
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" class="form-control" id="last_name" name="last_name" value="${sessionScope.authUser.lastName}"
            ...
            <div class="form-group mx-4">
                <label for="email" class="col-form-label-lg"><fmt:message key="email" bundle="${myBundle}" /> <p class="d-inline-block mb-0" style="color: red">
                    *</p></label>
                <input type="text" class="form-control" id="email" name="email" value="${sessionScope.authUser.email}"
