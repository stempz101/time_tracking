        ...
        <form action="<%= request.getContextPath() + "/a/add-cat" %>" class="col-8 border rounded mt-2"
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" class="form-control" id="categoryEN" name="categoryEN"
                       value="${sessionScope.categoryEN}" placeholder="Category" pattern="[a-zA-Z'\d\s]+" required>
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" class="form-control" id="categoryUA" name="categoryUA"
                       value="<c:out value="${sessionScope.categoryUA}" />" placeholder="Категорія"
                       pattern="[a-zA-Zа-щА-ЩЬьЮюЯяЇїІіЄєҐґ'\d\s]+" required>
            ...
            <div class="row form-group mx-4 my-3">
                <button class="btn btn-lg btn-primary" type="submit" name="sendMe" value="1">Add</button>
            </div>
            <c:if test="${sessionScope.successMessage != null}">
                <div class="alert alert-success mx-4 py-1">${sessionScope.successMessage}</div>
            </c:if>
        </form>
        <div class="col-2"></div>
    </div>
